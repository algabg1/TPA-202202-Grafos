...
public class GeradorArquivosGrafo {
    ...
    public void geraArquivo(int n) {
        ...
        try {
            ...
            // Como o grafo nao será direcional e nao tenho arestas ligando um vertice a ele
            // mesmo
            // teria uma matriz de adjacencia na qual a diagonal principal é toda de zeros
            // e os elementos acima da diagonal são iguais aos abaixo, isto é, o elemento
            // A(l,c) = A(c,l)
            // Assim vou gerar apenas os elementos que ficam acima da diagonal principal e
            // armazenar num vetor
            // Esse vetor terá seu tamanho dados por (qtd*qtd-qtd)/2 (resultado de uma
            // somatoria onde a primeira lina tem qtd-1 elementos
            ...
            // Nos laços abaixo imprimo a matriz de adjacencias completa, inclusive diagonal
            // principal e elementos abaixo dela
            // Para achar no vetor a distancia entre elementos usei a formula que desenvolvi
            // observado que a primeira linha tem qtd-1 elementos no vetor,
            // a segunda linha qtd-2 e assim sucessivamente até que a última linha tem zero.
            // Assim, vi que para obter o indice do primeiro elemento da linha no vetor
            // bastava resolver uma soma de PA e que a partir dele
    ...
    double geraDistancia(int linha, int coluna) {
        ...
        // Para garantir que o grafo será conexo garantirei que sempre haverá arestas
        // entre vertices que o codigo diferem de 1
        // A distancia dessas arestas será um numero aleatório entre 10 e 110
        if (coluna - linha == 1) {
            return r * 100 + 10;
        }
        // Para os demais gero um aleatório entre 0 e 1. Se for menor que 0.3 não haverá
        // aresta entre eles
        // caso contrário haverá aresta e a distancia da aresta será dada pelo numero
        // gerado * 100, ou seja, será algo entre 30 e 100.
        else {
            if (r < 0.3)
                return 0.0;
            else
    ...
    ////
    //// System.out.println("Tempo Total de geração do arquivo em ms: " +
